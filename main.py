...
przycisk1.grid(row=20, column=7, sticky="news")
przycisk2 = Button(root, text='Start', command=start)
przycisk2.grid(row=20, column=8, sticky="news")
przycisk3 = Button(root, text='Stop', command=stop)
przycisk3.grid(row=20, column=9, sticky="news")
przycisk4 = Button(root, text='Exit', command=exit)
przycisk4.grid(row=20, column=10, sticky="news")
